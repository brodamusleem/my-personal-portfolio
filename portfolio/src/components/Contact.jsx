        ...
        <div className="grid md:grid-cols-2 place-items-center">
            <div>
                <div className="text-gray-300 my-3">
                    ...
                    I'm a versatile developer with experience in a range of technologies and platforms.I specialize in building high-quality software solutions that deliver value to users and 
                     businesses alike.Whether you need a web app, a mobile app, or a bussiness partnership, I have the skills and 
                     experience to deliver and display result that exceed your expectation .
